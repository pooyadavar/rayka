...
const Portfolio: React.FC = () => {
  ...
  return (
    <Box sx={{ py: 12, bgcolor: alpha(theme.palette.background.default, 0.5), position: 'relative', overflow: 'hidden' }} id="portfolio">
      ...
      <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
        ...
        <Box textAlign="center" mb={10}>
             ...
             >
                <Typography variant="overline" sx={{ color: 'primary.main', fontWeight: 800, letterSpacing: 3, display: 'block', mb: 2, fontSize: '0.85rem' }}>
                    نمونه کارهای ما
                </Typography>
                <Typography variant="h3" fontWeight="900" sx={{ mb: 3, color: 'text.primary', fontSize: { xs: '2rem', md: '3rem' } }}>
                پروژه‌های <span style={{ color: theme.palette.primary.main }}>اجرا شده</span>
                </Typography>
                <Typography variant="body1" color="text.secondary" maxWidth={650} mx="auto" sx={{ lineHeight: 1.9, fontSize: '1.1rem' }}>
                    ...
                    >
                        ...
                        '&:hover': { 
                            ...
                            '& .details-arrow': {
                                ...
                                {/* Top: Chip */}
                                <Box sx={{ zIndex: 1, display: 'flex', justifyContent: 'flex-start' }}>
                                    <Chip 
                                        label={p.label} 
                                        size="small" 
                                        sx={{ 
                                ...
                                <Box sx={{ zIndex: 1, mt: 'auto' }}>
                                    ...
                                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                                        <Box sx={{ 
                                            ...
                                            <ArrowBackIcon className="details-arrow" sx={{ fontSize: 20, transition: 'transform 0.3s' }} />
                                        </Box>
                                        <Typography variant="button" fontWeight="700" sx={{ fontSize: '0.9rem', color: alpha('#fff', 0.9) }}>
                                            مشاهده پروژه
                                        </Typography>
                                    </Box>
                                </Box>
